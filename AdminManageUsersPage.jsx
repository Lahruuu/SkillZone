  ...
  const renderUserItem = (user, handleDeleteUser, handleUpdateUser) => (
    <div key={user.id}>
      ...
      <div classname="button-container">
        <button className="btn-delete" onClick={() => handleDeleteUser(user.id)}>Delete User</button>
        <button className="btn-modify" onClick={() => handleUpdateUser(user)}>Modify User</button>
      </div>
    </div>
  );
      ...
      <div className="container h-100">
        <div className="row h-100">
          <div className="col-12">
            ...
            <p><Link to="/admin_test" className="btn btn-success">Manage tests </Link></p>
