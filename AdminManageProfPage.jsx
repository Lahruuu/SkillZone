...
const AdminManageProfPage = () => {
  ...
  const [form] = Form.useForm(); // Form instance for resetting and managing fields
  ...
  return (
    <div>
      <h1>Professions Managing</h1>
      <p>
        <Link to="/admin_users" className="btn btn-success">
          Manage Users
        </Link>
      </p>
      <p>
        <Link to="/admin_prof" className="btn btn-success">
          Manage professions
        </Link>
      </p>
      <p>
        <Link to="/admin_test" className="btn btn-success">
          Manage tests
        </Link>
      </p>
        ...
        <Form.Item>
          ...
          <Button
            ...
            onClick={() => {
              ...
              setSelectedProfession(null); // Clear selected profession
            }}
          >
            Cancel
          </Button>
